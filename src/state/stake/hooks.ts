import { ChainId, CurrencyAmount, JSBI, Token, TokenAmount, WETH, Pair } from '@piggycoin/sdk'
import { useMemo } from 'react'
import { DAI, UNI, USDC, USDT, PIG } from '../../constants'
...
export const STAKING_REWARDS_INFO: {
  ...
  [ChainId.BSC_MAINNET]: [
    ...
    {
      tokens: [WETH[ChainId.BSC_MAINNET], PIG],
